...
const LOCKET_DATA = {
    ...
    commands: [
        {
            name: "Lệnh 1", 
            icon: "fas fa-cog",
            url: "shadowrocket://config/add/https://raw.githubusercontent.com/hoangnamnion/youtube/refs/heads/main/YOUTUBE_HOANGNAM.conf",
            type: "primary"
        },
        {
            name: "Lệnh 2",
    ...
    // Cấu hình UI
    ui: {
        title: "Youtube Hoàng Nam 💛",
        sectionTitles: {
            personal: "Thông tin cá nhân",
            gold: "Youtube Hoàng Nam 💛"
        },
        buttons: {
